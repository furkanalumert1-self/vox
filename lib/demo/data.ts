/**
 * Demo data — what makes the Vox cockpit feel alive with zero API keys. Labels
...
export const CALLS: CallRow[] = [
  {
    ...
    time: "14:32", duration: "3:12", durationSec: 192, outcome: "booked", sentiment: "positive", wave: wA,
    ...
    transcript: [
      { who: "agent", at: 0, text: { tr: "Briteline Temizlik'e hoş geldiniz, ben Vox. Size nasıl yardımcı olabilirim?", en: "Thanks for calling Brightline Cleaning, this is Vox. How can I help?" } },
  ...
  },
  {
    ...
    time: "14:18", duration: "1:54", durationSec: 114, outcome: "resolved", sentiment: "positive", wave: wB,
    ...
    transcript: [
      { who: "agent", at: 0, text: { tr: "Vox'a hoş geldiniz, ben dijital asistanınız. Hangi konuda arıyorsunuz?", en: "Welcome to Vox, I'm your digital assistant. What brings you in today?" } },
  ...
  },
  {
    ...
    time: "13:55", duration: "0:48", durationSec: 48, outcome: "transferred", sentiment: "neutral", wave: wC,
    ...
    transcript: [
      { who: "agent", at: 0, text: { tr: "Merhaba, ben Vox. Nasıl yardımcı olabilirim?", en: "Hi, this is Vox. How can I help?" } },
  ...
  },
  {
    ...
    time: "13:40", duration: "2:21", durationSec: 141, outcome: "booked", sentiment: "positive", wave: wA,
    ...
    transcript: [
      { who: "agent", at: 0, text: { tr: "Cedar Diş Kliniği, ben Vox. Size nasıl yardımcı olabilirim?", en: "Cedar Dental, this is Vox. How can I help you today?" } },
  ...
  },
  {
    ...
    time: "13:12", duration: "0:32", durationSec: 32, outcome: "voicemail", sentiment: "neutral", wave: wB,
  ...
  },
  {
    ...
    time: "12:48", duration: "4:05", durationSec: 245, outcome: "resolved", sentiment: "positive", wave: wC,
    ...
    transcript: [
      { who: "agent", at: 0, text: { tr: "Cedar Klinik, ben Vox. Nasıl yardımcı olabilirim?", en: "Cedar Clinic, this is Vox. How can I help?" } },
  ...
  },
  {
    ...
    time: "12:20", duration: "1:38", durationSec: 98, outcome: "missed", sentiment: "negative", wave: wA,
  ...
  },
  {
    ...
    time: "11:54", duration: "2:57", durationSec: 177, outcome: "booked", sentiment: "positive", wave: wB,
    ...
    transcript: [
      { who: "agent", at: 0, text: { tr: "Harborline Emlak, ben Vox. Size nasıl yardımcı olabilirim?", en: "Harborline Realty, this is Vox. How can I help?" } },
...
export const AGENTS: Agent[] = [
  {
    ...
    greeting: { tr: "Briteline'a hoş geldiniz, ben Vox. Size nasıl yardımcı olabilirim?", en: "Thanks for calling Brightline, this is Vox. How can I help?" },
    actions: [{ tr: "Takvime randevu al", en: "Book to calendar" }, { tr: "Canlı transfer", en: "Warm transfer" }, { tr: "SMS gönder", en: "Send SMS" }],
  },
  {
    ...
    greeting: { tr: "Vox'a hoş geldiniz! Hangi konuda yardımcı olabilirim?", en: "Welcome to Vox! What can I help you with today?" },
    actions: [{ tr: "Adayı puanla", en: "Score the lead" }, { tr: "Slack'e bildir", en: "Notify Slack" }, { tr: "CRM'e yaz", en: "Write to CRM" }],
  },
  {
    ...
    greeting: { tr: "Cedar Klinik, ben Vox. Size nasıl yardımcı olabilirim?", en: "Cedar Clinic, this is Vox. How can I help you today?" },
    actions: [{ tr: "Randevu al", en: "Book appointment" }, { tr: "Reçete yenile", en: "Refill prescription" }, { tr: "Hatırlatma kur", en: "Set reminder" }],
  },
  {
    ...
    actions: [{ tr: "Mesaj al", en: "Take a message" }, { tr: "Acil ise yönlendir", en: "Escalate if urgent" }],
  },
];
...
/* The action toggles in the agent-builder preview. */
export const BUILDER_ACTIONS: { id: string; label: L; on: boolean }[] = [
  { id: "book", label: { tr: "Takvime randevu al", en: "Book to calendar" }, on: true },
  { id: "transfer", label: { tr: "Canlı temsilciye transfer", en: "Transfer to a human" }, on: true },
  { id: "sms", label: { tr: "Onay SMS'i gönder", en: "Send confirmation SMS" }, on: true },
  { id: "crm", label: { tr: "CRM'e kaydet", en: "Log to CRM" }, on: false },
  { id: "qualify", label: { tr: "Adayı nitelendir & puanla", en: "Qualify & score lead" }, on: false },
];
...
export const DEMO_SCRIPT: Turn[] = [
  { who: "agent", at: 0, text: { tr: "Briteline'a hoş geldiniz, ben Vox. Size nasıl yardımcı olabilirim?", en: "Thanks for calling Brightline, this is Vox. How can I help?" } },
...
export const TESTIMONIALS: Testimonial[] = [
  { quote: { tr: "Vox geceleri gelen aramaların hepsini karşılıyor. İlk ay randevularımız %34 arttı.", en: "Vox answers every after-hours call. Bookings jumped 34% in the first month." }, name: "Dr. Lena Hart", role: { tr: "Cedar Diş Kliniği", en: "Cedar Dental" }, initials: "LH" },
  ...
  { quote: { tr: "Bir resepsiyonist işe almak yerine Vox'u açtık. Üç kişilik bir ekibin işini yapıyor.", en: "Instead of hiring a receptionist we switched on Vox. It does the work of a three-person desk." }, name: "Owen Frost", role: { tr: "Operasyon, Brightline", en: "Ops, Brightline" }, initials: "OF" },
...
export const METRICS: { value: string; label: L }[] = [
  { value: "1.4M+", label: { tr: "işlenen arama", en: "calls handled" } },
  { value: "98%", label: { tr: "arama karşılama oranı", en: "answer rate" } },
  { value: "<700ms", label: { tr: "yanıt gecikmesi", en: "response latency" } },
  { value: "4.9/5", label: { tr: "müşteri puanı", en: "customer rating" } },
];

export const HOW_STEPS: { icon: string; title: L; body: L }[] = [
  { icon: "phone", title: { tr: "Bir numara al", en: "Get a number" }, body: { tr: "Saniyeler içinde bir Vox numarası al veya mevcut numaranı taşı.", en: "Grab a Vox number in seconds, or port your existing line." } },
  ...
  { icon: "phone-incoming", title: { tr: "Aramaları açsın", en: "It answers calls" }, body: { tr: "Vox 7/24 açar, randevu alır, nitelendirir, yönlendirir — sen uyurken bile.", en: "Vox answers 24/7 — booking, qualifying and routing, even while you sleep." } },
];
